...
namespace Bloxstrap
{
    internal class Installer
    {
        ...
        public static void DoUninstall(bool keepData)
        {
            ...
            try { Registry.CurrentUser.DeleteSubKey(App.ApisKey); } catch { }
            ...
            cleanupSequence.Add(() => { try { Registry.CurrentUser.DeleteSubKey(App.UninstallKey); } catch { } });
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                    Utilities.ShellExecute($"https://wiki.goldstrap.app/patch-notes/v{currentVer.Replace(".", "-")}");
