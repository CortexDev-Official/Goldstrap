    ...
    public abstract class WpfUiWindow : UiWindow
    {
        ...
        public void ApplyTheme(bool useAcrylic = false)
        {
            ...
            if (App.Settings.Prop.UseAcrylicBackground && useAcrylic)
            {
                ...
                if (isDark)
                {
                    this.Resources["MainWindowBackgroundBrush"] = new SolidColorBrush(Color.FromArgb(opacity, 19, 17, 16));
                    this.Background = new SolidColorBrush(Color.FromArgb(80, 19, 17, 16));
                }
                else
                {
                    this.Resources["MainWindowBackgroundBrush"] = new SolidColorBrush(Color.FromArgb(opacity, 250, 248, 244));
                    this.Background = new SolidColorBrush(Color.FromArgb(80, 250, 248, 244));
                }
            }
            else
            {
