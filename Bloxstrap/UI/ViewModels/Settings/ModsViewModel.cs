...
namespace Bloxstrap.UI.ViewModels.Settings
{
    public class ModsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public EnumModPresetTask<Enums.CursorType> CursorTypeTask { get; } = new("CursorType", new()
        {
            ...
            {
                Enums.CursorType.MacOS, new()
                {
                    { @"content\textures\Cursors\KeyboardMouse\ArrowCursor.png",    "Cursor.MacOS.ArrowCursor.png"    },
                    { @"content\textures\Cursors\KeyboardMouse\ArrowFarCursor.png", "Cursor.MacOS.ArrowFarCursor.png" },
                    { @"content\textures\Cursors\KeyboardMouse\IBeamCursor.png",    "Cursor.MacOS.IBeamCursor.png"    }
                }
            },
            {
                Enums.CursorType.RetroModern, new()
                {
                    { @"content\textures\Cursors\KeyboardMouse\ArrowCursor.png",    "Cursor.RetroModern.ArrowCursor.png"    },
                    { @"content\textures\Cursors\KeyboardMouse\ArrowFarCursor.png", "Cursor.RetroModern.ArrowFarCursor.png" },
                    { @"content\textures\Cursors\KeyboardMouse\IBeamCursor.png",    "Cursor.RetroModern.IBeamCursor.png"    },
                    { @"content\textures\MouseLockedCursor.png",                    "Cursor.RetroModern.MouseLockedCursor.png" }
                }
            },
            {
                Enums.CursorType.FPS, new()
                {
                    { @"content\textures\Cursors\KeyboardMouse\ArrowCursor.png",    "Cursor.FPS.ArrowCursor.png"    },
                    { @"content\textures\Cursors\KeyboardMouse\ArrowFarCursor.png", "Cursor.FPS.ArrowFarCursor.png" },
                    { @"content\textures\Cursors\KeyboardMouse\IBeamCursor.png",    "Cursor.FPS.IBeamCursor.png"    },
                    { @"content\textures\MouseLockedCursor.png",                    "Cursor.FPS.MouseLockedCursor.png" }
                }
            }
        });
