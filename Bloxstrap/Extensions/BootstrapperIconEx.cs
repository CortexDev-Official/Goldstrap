...
namespace Bloxstrap.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        {
            BootstrapperIcon.IconGoldstrap,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconGoldstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconGoldstrap => Properties.Resources.IconGoldstrap,
                BootstrapperIcon.IconBloxstrap => Properties.Resources.IconGoldstrap,
                ...
                _ => Properties.Resources.IconGoldstrap
            };
        }
    }
}
